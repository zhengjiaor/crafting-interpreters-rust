...
impl Token {
    pub fn new(token_type: TokenType, lexeme: String, literal: LiteralValue, line: usize) -> Token {
...
impl Scanner {
    ...
    pub fn scan_tokens(mut self) -> Result<Vec<Token>> {
        ...
        self.tokens.push(Token::new(TokenType::Eof, "".to_string(), LiteralValue::None, self.line));
